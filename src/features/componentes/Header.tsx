    ...
    return (
        <header className="sticky top-0 z-30 border-b border-white/10 bg-slate-950/80 backdrop-blur">
            <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
                ...
                >
                    <span
                        className={`h-[3px] rounded bg-[#e9f2ff] transition-transform ${open ? "translate-y-[9px] rotate-45" : ""
                            }`}
                    />
                    <span
                        className={`h-[3px] rounded bg-[#e9f2ff] transition-opacity ${open ? "opacity-0" : "opacity-100"
                            }`}
                    />
                    <span
                        className={`h-[3px] rounded bg-[#e9f2ff] transition-transform ${open ? "-translate-y-[9px] -rotate-45" : ""
